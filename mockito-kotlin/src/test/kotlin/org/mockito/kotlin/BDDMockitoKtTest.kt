...
class BDDMockitoKtTest {
    ...
    @Test
    fun willReturn() = runBlocking {
        val fixture: SomeInterface = mock()

        given(fixture.suspending()).willReturn { 42 }
    ...
    @Test
    fun willSuspendableAnswer_givenBlocking_suspendLambdaAnswer() {
        val fixture: SomeInterface = mock()

        givenBlocking { fixture.suspending() }.willSuspendableAnswer { 42 }
    ...
    fun willSuspendableAnswer_givenBlocking_withArgument() {
        ...
        givenBlocking { fixture.suspendingWithArg(any()) }
            .willSuspendableAnswer { withContext(Dispatchers.Default) { it.getArgument(0) } }
